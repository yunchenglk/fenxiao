<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomPageEdit.aspx.cs" MasterPageFile="~/Admin/AdminNew.Master" Inherits="Hidistro.UI.Web.Admin.Shop.CustomPageEdit" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <!-- diy css start-->
    <link rel="stylesheet" href="/Admin/Shop/Public/common.css?20160818" />
 ...
 .g-flex{margin-left:2px}*/
        ...
        .ctrl-item-list-li .formitems .form-controls a {
            max-width: 115px;
        }
        ...
        <div class="inner clearfix" style="margin: 0px; border: none;">
            ...
            <div class="content-right fl" style="border: none; padding: 0px;">
                ...
                <div class="page-header">
                    <h2 style="font-size: 20px;">编辑页面</h2>
                </div>
                ...
                <div class="app_inner_content">
                    ...
                    <div class="diy clearfix">
                        <div class="diy-phone-outbox clearfix">
                            <div id="diy-phone">
                                <div class="diy-phone-header">
                                    ...
                                    <div class="diy-phone-title j-pagetitle">页面标题</div>
                                </div>
                                <div class="diy-phone-contain" id="diy-contain">
                                    <div class="nodrag"></div>
                                    <div class="drag" style="margin-top: -10px;"></div>
                            ...
                            <div class="diy-ctrl-item" data-origin="pagetitle" style="margin-top: 85px;">
                                <div class="formitems">
                                    ...
                                    <div class="form-controls">
                                        <input type="text" class="input j-pagetitle-ipt" value="<%= model.Status ==0?model.Name:model.DraftName %>">
                                    </div>
                                </div>
                                <div class="formitems">
                                    <label class="fi-name">页面描述：</label>
                                    <div class="form-controls">
                                        <input type="text" class="input j-pagesubtitle-ipt" value="<%= model.Status ==0?model.Details:model.DraftDetails %>">
                                    </div>
                                </div>
                                <div class="formitems">
                                    <label class="fi-name">店铺导航：</label>
                                    <div class="form-controls">
                                        <div class="checkbox-group bl mb10">
                                            <label>
                                                <input type="checkbox" id="j-isshowmenu" <%=  model.Status ==0? (model.IsShowMenu==true?"checked":""): (model.DraftIsShowMenu==true?"checked":"") %> name="showBomMenu">显示</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="formitems">
                                    <label class="fi-name">页面地址：</label>
                                    <div class="form-controls">
                                        http://<%=HttpContext.Current.Request.Url.Host %>/custom/
                                        <input type="text" class="input j-pagecustname" style="width:120px;" value="<%= model.Status ==0?model.PageUrl:model.DraftPageUrl %>">
                        ...
                        <div class="diy-actions-submit">
                            ...
                            <a href="javascript:;" class="btn btn-primary inputw100" id="j-saveDraftPage">存草稿</a>
        ...
        <div class="members_con">
            ...
            <section class="members_goodspic">
                <ul>
                    ...
                    <li class="mingoods">
                        ...
                        <# if(content.showName){ #>
                        <a class="alink" href="<#= goods.link #>"><#= goods.title #></a>
                        <# } #>
                        <# if(content.showIco || content.showPrice){ #>
                        <span class="replace">
                            <# if(content.showIco){ #>
            ...
            <section class="members_goodslist">
                <ul>
                    <# if (content.goodslist.length){ #>
                    <# _.each(content.goodslist,function(goods){ #>
                    <li class="g-box por rebox" style="width: 300px;">
    ...
    <!-- end CategoriesPicker -->
       ...
       <!-- start CustomPage -->
    <script type="text/j-template" id="tpl_popbox_CustomPagePicker">
        <div id="GoodsAndGroupPicker">
            <div class="tabs clearfix">
                <a href="javascript:;" class="active tabs_a fl" data-origin="goodsandgroup" data-index="1">商品</a>
                <a href="javascript:;" class="tabs_a fl j-tab-group" data-origin="goodsandgroup" data-index="2">商品分组</a>
    ...
    <script type="text/j-template" id="tpl_popbox_CustomPagePicker_graphicsitem">
       <# _.each(dataset,function(data){#>
        <li class="clearfix" data-item="<#= data.item_id #>">
            <a href="<#= data.link #>" class="fl" target="_blank" title="<#= data.title #>">
             <div class="table-item-img" style="display:none;">
                    <# if(data.is_compress){ #>
                    <img src="<#= data.pic #>80x80" alt="<#= data.title #>">
                    <# }else{ #>
                    <img src="<#= data.pic #>" alt="<#= data.title #>">
     ...
     <script type="text/j-template" id="tpl_popbox_CustomPicker_groupitem">
        <# _.each(dataset,function(data){#>
        <li class="clearfix" data-group="<#= data.group_id #>">
            <a href="<#= data.link #>" class="fl a_hover" target="_blank" title="<#= data.title #>"><#= data.title #></a>
            <a href="javascript:;" class="btn fr j-select">选取</a>
    ...
    <script src="/Admin/shop/Public/plugins/diy/diy.goods.js?20160505"></script>
    ...
    <script src="/Admin/shop/Public/plugins/colorpicker/colorpicker.js"></script>
    <%=scriptLinkSrc %>
    <script src="/Admin/shop/Public/js/dist/home/Shop/edit_custompage.js"></script>
    ...
    <script>
        ...
        $(function () {
            ...
            $(".diy-phone-title").click(function () {
