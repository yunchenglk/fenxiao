...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        function checkForm() {
            ...
            var m = parseFloat($("#ctl00_ContentPlaceHolder1_txtApplySet").val().trim());
            if (!/^([1-9][\d]{0,7}|0)(\.[\d]{1,2})?$/.test(m) || m == "" || m < 0.01)
            {
                HiTipsShow("请填写适当的最低提现金额,不能小于数值0.01！", 'error');
                return false;
            }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-horizontal" >
        ...
        <div class="form-group">
                        ...
                        <div class="col-xs-5">
                               <asp:TextBox ID="txtApplySet" CssClass="form-control" Text="1" style="width:100px" runat="server" onkeyup="this.value = (this.value.match(/\d+(\.\d{0,2})?/) || [''])[0]"></asp:TextBox>
                            <small>设置分销商佣金提现、会员帐户余额提现的最低金额，单位：元</small>
                        </div>
                    </div>
