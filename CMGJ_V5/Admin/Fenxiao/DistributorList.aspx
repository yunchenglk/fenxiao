...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script>
        ...
        $(function () {
            ...
            var phoneReg = eval($('#ctl00_hiddTelReg').val());
            //编辑页面的验证
                    ...
                    <div class="set-switch">
                        <div class="form-inline mb10">
                            <div class="form-group mr20">
                                <label for="ctl00_ContentPlaceHolder1_txtStoreName">店铺名：</label>
                        ...
                        <div class="title-table">
                            <table class="table">
                                <thead>
                                    <tr>
                                        <th width="10%">头像</th>
                                        <th width="15%" style="text-align: left">昵称/手机</th>
                                        <th width="15%">用户名</th>
                            ...
                            <table class="table">
                                <tbody>
                                    <asp:Repeater ID="reDistributor" runat="server">
                                        <ItemTemplate>
                                            <tr>
                                                ...
                                                <td width="15%"><%# Eval("UserBindName")%></td>
                                    ...
                                    DeleteMsg="取消分销商资质以后不可恢复也不能重新申请，是否继续？" />--%>
                                                        <asp:Button ID="ImageLinkButton1" Visible="false" CommandName="Forbidden" CommandArgument='<%# Eval("UserId")%>' runat="server" Text="取消分销商资质" class="btnLink pad" IsShow="true" OnClientClick="return HiConform('<strong>取消分销商资质以后不可恢复也不能重新申请。</strong><p>是否继续？</p>', this);" />
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-7" style="margin-top: 4px;">
                                <input type="text" runat="server" name="txtCommission" id="txtCommission" style="width: 160px" maxlength="9" placeholder="正数加佣金，负数减佣金" />
                                元
                            </div>
                        </div>
                        <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:HiddenField ID="hdVery" runat="server" Value="0" />
