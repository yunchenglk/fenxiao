        ...
        <div id="mytabl">
            ...
            <div class="table-page">
                <ul class="nav nav-tabs" style="display: none">
                    ...
                    <li id="liOper1" style="display: none">
                        <asp:HyperLink runat="server" NavigateUrl="Finished.aspx?stype=1"><span>货到付款订单</span></asp:HyperLink></li>
                </ul>
            </div>
                ...
                <div class="tab-pane active">
                    <div class="set-switch">
                        <div class="form-inline mb10">
                            ...
                            <div class="form-group mr20">
                                <label for="sellshop1">快递单号：</label>
                                <asp:TextBox ID="txtShipId" runat="server" CssClass="form-control resetSize inputw150" />
                            </div>
                            <div class="form-group mr20">
