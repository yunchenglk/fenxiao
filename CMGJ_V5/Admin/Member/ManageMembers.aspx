...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <form id="thisForm" runat="server" class="form-horizontal">                     
        ...
        <div>
			...
			<th style="width: 47px; text-align: center;"><span id="ctl00_ContentPlaceHolder1_grdMemberList_ctl01_label">选择</span></th><th style="text-align: center;width:100px">头像</th><th style="text-align: center;width:112px">昵称/手机</th><%--<th style="width:135px">微信OpenID</th>--%><th style="text-align: center;width:86px">用户名</th><th style="text-align: center;width:106px">会员等级</th><th style="text-align: center;width:99px">上级</th><th style="text-align: center;width:106px">订单数/消费额</th><th style="text-align: center;width:135px">账户余额</th><th style="text-align: center;width:124px">注册时间</th><th  style="text-align: center;width:97px">&nbsp;</th>
		</tr></thead></table></div>
            <div id="datalist">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="订单数/消费额" ItemStyle-HorizontalAlign="Center" ShowHeader="true" ItemStyle-Width ="106">
                     ...
                     <asp:TemplateField HeaderText="账户余额" ItemStyle-Width="135" ItemStyle-HorizontalAlign="Center" ShowHeader="true">
                        <ItemTemplate>
                            <p style="color:#F60;">
                             ￥<%# Convert.ToDouble ( Eval("AvailableAmount")).ToString ("f2")%>
                                </p>
                        </ItemTemplate>
                    </asp:TemplateField>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" style="text-align:left" >调整经验</h4>
              </div>
                <div class="modal-body form-horizontal" >
                    <div class="form-group">
                                <label for="inputEmail3" class="col-xs-4 control-label">现有经验：</label>
                                <div class="col-xs-6">
                                    <label id="lbNowPoint" style="margin-top:7px;display:block">0</label>
                                </div>
                        </div>
                     <div class="form-group">
                                <label for="inputEmail3" class="col-xs-4 control-label"><em>*</em>调整经验：</label>
                                <div class="col-xs-6">
  ...
  <div class="modal-dialog">
    ...
    <script type="text/javascript">
        ...
        function ShowCreatDistr(obj) {
            ...
            HiTipsShow("当前已选择" + selnum + "位会员，确定设置成代理商？", "confirm", "ctl00_ContentPlaceHolder1_BatchCreatDist");
