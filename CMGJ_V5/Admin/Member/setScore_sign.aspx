...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
        ...
        #signmainDiv input[type='checkbox'] {
            margin-bottom: 5px;
        }
    </style>
    ...
    <form id="thisForm" runat="server" class="form-horizontal">
        ...
        <div class="play-tabs">
            <ul id="tabHeader" class="nav nav-tabs" role="tablist">
                <li role="presentation" id="signTab" class="active"><a href="setScore_sign.aspx">签到送经验</a></li>
                <li role="presentation" id="shoppingTab"><a href="setScore_shopping.aspx">购物送经验</a></li>
            </ul>
                    ...
                    <div id="signmainDiv" style="<%=_signEnable?"": "display:none" %>">
                        <div class="form-group">
                            <div class="form-inline">
                                ...
                                <div class="col-xs-3">
                                    <asp:TextBox ID="txtEverDayScore" CssClass="form-control" runat="server" /><label style="font-weight: normal; margin-left: 3px;">经验</label>
                                </div>
                            </div>
                        </div>
                        <div class="form-group" style="display: none">
                            <div class="form-inline">
                                <label class="col-xs-2 control-label">
                                    <input id="chkContinuity" type="checkbox" <%=_continuityEnable ? "checked" : ""%> />
                                    每连续签到</label>
                                <div class="col-xs-6">
