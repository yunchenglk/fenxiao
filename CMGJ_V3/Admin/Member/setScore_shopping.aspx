...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <style type="text/css">
      ...
      #shoppingmainDiv  input[type='checkbox'] {
            margin-bottom: 5px;
        }
    </style>
    <script type="text/javascript">
        $(document).ready(function () {
            $('input[type=text]').each(function () {
                $(this).on('blur', function () {
                    ...
                    if (id.indexOf("txt_ShoppingScore") > 0 || id.indexOf("txt_OrderValue") > 0 || id.indexOf("txt_shopping_RewardScore") > 0 || id.indexOf("txt_ShoppingScoreUnit") > 0) {
                        ...
                        var flag4 = testInput($('#<%=txt_ShoppingScoreUnit.ClientID%>'));
        ...
        function testInput(obj) {
            ...
            if (id == "ctl00_ContentPlaceHolder1_txt_ShoppingScoreUnit") {
                regex = /^[0-9]*$/;
            }
    ...
    <div class="play-tabs">
        ...
        <ul id="tabHeader" class="nav nav-tabs" role="tablist">
            ...
            <li role="presentation" id="shoppingTab" class="active"><a href="setScore_shopping.aspx">购物送积分</a>
             ...
             <li role="presentation" id="shareTab"><a href="setScore_share.aspx">
                分享送经验</a></li>
        </ul>
