...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div>
            ...
            <div>
                <ul class="nav nav-tabs">
                    <li dataid="normal"><a href="/admin/Member/ManageMembers.aspx">
                        <asp:Literal ID="ListActive" Text="所有会员" runat="server"></asp:Literal></a></li>
                    <li dataid="new"><a href="/admin/Member/ManageMembers.aspx?clientType=new">
                        <asp:Literal ID="Listfrozen" Text="新会员" runat="server"></asp:Literal></a></li>
                    <li dataid="activy"><a href="/admin/Member/ManageMembers.aspx?clientType=activy">
                        <asp:Literal ID="Literal1" Text="活跃会员" runat="server"></asp:Literal></a></li>
                    <li dataid="sleep"><a href="/admin/Member/ManageMembers.aspx?clientType=sleep">
                        <asp:Literal ID="Literal2" Text="沉睡会员" runat="server"></asp:Literal></a></li>
                </ul>
                    ...
                    <div class="set-switch">
                        ...
                        <div class="form-inline ">
                            ...
                            <div class="form-group" style="margin-left: 30px;">
                                <label>会员等级：</label>
                                <Hi:MemberGradeDropDownList ID="rankList" Width="188" runat="server" CssClass="form-control resetSize" AllowNull="true" NullToDisplay="全部" />
                            </div>
                            <div class="form-group" style="margin-left: 17px;">
                                <label class="ml10">会员状态：</label>
                                <asp:DropDownList ID="MemberStatus" runat="server" CssClass="form-control  resetSize inputw150">
                                    <asp:ListItem Text="正常" Value="1" Selected="True">正常</asp:ListItem>
                                    <asp:ListItem Text="已删除" Value="7">已删除</asp:ListItem>
                                    <asp:ListItem Text="潜在会员" Value="9">潜在会员</asp:ListItem>
                    ...
                    <table class="table table-hover mar table-bordered" style="border-bottom: none;">
                        <thead>
                            <tr>
                                ...
                                <th style="text-align: center; width: 112px">昵称/手机</th>
                                <%--<th style="width:135px">微信OpenID</th>--%><th style="text-align: center; width: 86px">用户名</th>
                                <th style="text-align: center; width: 106px">会员等级</th>
                                <th style="text-align: center; width: 99px">上级</th>
                                <th style="text-align: center; width: 106px">订单数/消费额</th>
                                <th style="text-align: center; width: 135px">账户余额/冻结金额</th>
                                <th style="text-align: center; width: 124px">注册时间</th>
                                <th style="text-align: center; width: 97px">&nbsp;</th>
                            </tr>
                        </thead>
                    </table>
                </div>
                <div id="datalist">
                    <UI:Grid ID="grdMemberList" runat="server" ShowHeader="true" AutoGenerateColumns="false"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="头像" ItemStyle-Width="80" SortExpression="UserName" HeaderStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="昵称/手机" ItemStyle-Width="112" SortExpression="UserName" HeaderStyle-HorizontalAlign="Center">
                                <ItemTemplate>
                                    <p>
                                        <asp:Literal ID="lblUserName" runat="server" Text='<%# Eval("UserName").ToString()==""?"<span style=\"color:gray\">未设置</span>":Eval("UserName") %>' /></p>
                                    ...
                                    <asp:HiddenField Value="<%# Eval("IsFollowWeiXin")%>" />
                                </ItemTemplate>
                            </asp:TemplateField>
                        ...
                        <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="账户余额" ItemStyle-Width="135" ItemStyle-HorizontalAlign="Center" ShowHeader="true">
                                <ItemTemplate>
                                    <p style="color: #F60;">
                                        ￥<%# Convert.ToDouble ( Eval("AvailableAmount")).ToString ("f2")%>/￥<%# Convert.ToDouble ( Eval("DAmount")).ToString ("f2")%>
                                    </p>
                                </ItemTemplate>
                            </asp:TemplateField>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-6">
                                <input type="text" name="txtPoint" id="txtPoint" style="width: 160px;" onkeyup="this.value = (this.value.match(/^[\+\-]?\d*?\.?\d{0,2}?$/) || [''])[0]" maxlength="9" placeholder="正数加积分，负数减积分" />
                            </div>
                        </div>
                        <div class="form-group">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body form-horizontal">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3" class="col-xs-4 control-label"><em>*</em>调整备注：</label>
                            <div class="col-xs-6">
                                <textarea id="txtSetAmountBark" name="txtSetAmountBark" rows="3" style="width: 200px;" placeholder="余额调整备注说明" maxlength="50"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div class="modal fade" id="GroupShow">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        <asp:Button ID="GroupCheck" class="btn btn-primary" Text="确定修改" runat="server" />
                        <button type="button" class="btn btn-default" data-dismiss="modal">关闭</button>
    ...
    <script type="text/javascript">
        ...
        function SetUserPoint(id, point) {
            ...
            $("#txtPoint").val("");
            $("#txtSetPointBark").val("");
            $("#btnUpdatePoint").unbind('click').bind('click', function () {
                var setPoint = $("#txtPoint").val();
                if (setPoint == "" || parseFloat(setPoint) == 0) {
                    ShowMsg("调整积分请输入大于0的整数!", false);
                    return false;
                }
                ...
                var setPointBark = $("#txtSetPointBark").val();
                if (setPointBark == "" || setPointBark == null || setPointBark == undefined) {
                ...
                var data = "action=SetUserPointByAdmin&userid=" + userId + "&setPoint=" + setPoint + "&remark=" + remark + "&t=" + (new Date()).getTime();
        ...
        //修改余额
        function SetUserAmount(id, amount, username) {
            $("#txtTitle").text("调整账户余额-" + username);
            $("#txtAmountUserId").val(id);
            $("#lbNowAmount").text("￥" + amount);
            ...
            $("#btnUpdateAmount").unbind('click').bind('click', function () {
                ...
                var userId = $("#txtAmountUserId").val();
                if (remark.trim() === "") {
                    ShowMsg("调整备注不能为空", false);
                    return false;
                }

                if (parseInt(setAmount) + parseInt(amount) < 0) {
                    ShowMsg("减去余额不能大于当前余额!", false);
                    return false;
                }
                $(this).attr("disabled", "disabled");
                var tempUrl = location.href;
                //var result = ManageMembers.SetUserAmount(userId, setAmount, remark);
        ...
        $(document).ready(function () {
            ...
            $(".CustomGroup").click(function () {
                ...
                $("#ctl00_ContentPlaceHolder1_hdCustomGroup").val(customGroup);
            });
