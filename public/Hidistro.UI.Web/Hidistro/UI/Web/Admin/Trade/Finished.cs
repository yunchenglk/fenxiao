namespace Hidistro.UI.Web.Admin.Trade
{
    ...
    public class Finished : AdminPage
    {
        ...
        private OrderQuery GetOrderQuery()
        {
            ...
            {
                query.ShipId = Globals.UrlDecode(this.Page.Request.QueryString["ShipId"]);
            }
        ...
        private void ReloadOrders(bool isSearch)
        {
            ...
            queryStrings.Add("ShipId", this.txtShipId.Text);
        ...
        protected void rptList_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if ((e.Item.ItemType == ListItemType.Item) || (e.Item.ItemType == ListItemType.AlternatingItem))
            {
                ...
                if (member != null)
                {
                    literal.Text = "买家：" + member.UserName + "<div style='display:none' mid='true' >" + member.UserId + "</div>";
                }
                StringBuilder builder = new StringBuilder();
